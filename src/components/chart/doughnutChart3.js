...
onClick = (e) => {
  ...
  renderStock(){
    ...
    let todayFormat =  moment(dateCombine).formatDate('YYYY-MM-DD');
    let todayFormat2 =  moment(dateCombine2).forma('YYYY-MM-DD');
